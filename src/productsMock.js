export let products = [
  {
    ...
    stock: 4,
    description:
      "Procesador de gama media-alta, ideal para juegos triple A y calidad precio rendimiento",
    category: "procesador",
  ...
  },
  {
    ...
    stock: 5,
    description:
      "La tarjeta grafica mas vendida del mercado, potencia, rendimiento, refrigeracion y alto desempeño",
    category: "graficas",
  ...
  },
  {
    ...
    stock: 5,
    description:
      "Desempeño, diseño, alto rendimiento y calidad precio, gran capacidad de procesamiento grafico",
    category: "graficas",
